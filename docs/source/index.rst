Welcome to CATNIP's documentation!
===================================
...
The data that CATNIP is currently able to process includes near infrared images from SPHERE, GPI, and Subarau, and radio images from ALMA. As of now, there are only options to select SPHERE or ALMA as the telescope. We will add more telescope options. We are in the process of releasing a version that can process line emission images as well. 
